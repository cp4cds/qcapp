# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-04-05 07:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variable', models.CharField(max_length=20)),
                ('esgf_ds_id', models.CharField(blank=True, max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_qc', models.ManyToManyField(to='qcapp.DataFile')),
            ],
        ),
        migrations.CreateModel(
            name='QCerror',
            fields=[
                ...
                ('qc_check', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qcapp.QCcheck')),
            ],
        ),
        migrations.AddField(
            model_name='dataset',
